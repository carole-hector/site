import Vue from "vue"
import vpost from "~/components/post/v-post.vue"
...
import vmenuIcon from "~/components/icons/v-menu-icon.vue"
import vhomeIcon from "~/components/icons/v-home-icon.vue"
import vcancelIcon from "~/components/icons/v-cancel-icon.vue"
...
import vpostPreview from "~/components/post/v-post-preview.vue"
import vpostMini from "~/components/post/v-post-mini.vue"
import vcaroleMini from "~/components/v-carole-mini.vue"
...
Vue.component(vmenuIcon.name, vmenuIcon)
Vue.component(vuserIcon.name, vuserIcon)
Vue.component(vcancelIcon.name, vcancelIcon)
...
Vue.component(vcaroleMini.name, vcaroleMini)
